...
/**
 * @author songyinyin
 * @see site.sorghum.anno.modular.anno.annotation.field.AnnoField
...
public class AnField {
     ...
     * 标题
     *
     * @see site.sorghum.anno.modular.anno.annotation.field.AnnoField#title()
     */
     ...
     * 表字段名
     *
     * @see site.sorghum.anno.modular.anno.annotation.field.AnnoField#tableFieldName()
     */
     ...
     *
     * @see site.sorghum.anno.modular.anno.annotation.field.AnnoField#defaultValue()
     */
     ...
     * 显示
     *
     * @see site.sorghum.anno.modular.anno.annotation.field.AnnoField#show()
     */
     ...
     * 数据类型
     *
     * @see site.sorghum.anno.modular.anno.annotation.field.AnnoField#dataType()
     */
