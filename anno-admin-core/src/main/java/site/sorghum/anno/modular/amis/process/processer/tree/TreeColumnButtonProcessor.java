                ...
                ((DrawerButton) action).setDrawer(
                    new DrawerButton.Drawer() {{
                        ...
                        setBody(
                            new IFrame() {{
                                setType("iframe");
                                setSrc("/index#/amisSingle/index/" + o2MJoinButton.joinAnnoMainClazz().getSimpleName() + "?isM2m=true&" + o2MJoinButton.joinOtherClazzField() + "=${" + o2MJoinButton.joinThisClazzField() + "}");
                            }}
                        );
