 ...
 */
@Named
public class AnnoStpClientUtil {

    public AnnoStpClientUtil() {}

    /**
     * 多账号体系下的类型标识
     */
    public static final String TYPE = "anno-client-login";

    /**
     * 令牌名称
     */
    public static final String TOKEN_NAME = "anno-client-token";
    ...
    public static AnnoAuthUser getAuthUser(String token) {
        SaSession tokenSessionByToken = AnnoStpClientUtil.getTokenSessionByToken(token);
    ...
    public static AnnoAuthUser setAuthUser(AnnoAuthUser authUser) {
        SaSession sessionByToken = AnnoStpClientUtil.getTokenSessionByToken(getTokenValue());
