...
public class MySqlSeriesDfsService extends AbstractDFsService {
    ...
    public void init(AppContext context) {
        ...
        MySQLProperty mySQLProperty = new MySQLProperty()
            ...
            .setUrl(fetchProperty(context, TYPE_MYSQL, KEY_URL))
            .setUsername(fetchProperty(context, TYPE_MYSQL, KEY_USERNAME))
            .setPassword(fetchProperty(context, TYPE_MYSQL, KEY_PASSWORD))
            .setAutoCreateTable(Boolean.TRUE.toString().equalsIgnoreCase(fetchProperty(context, TYPE_MYSQL, KEY_AUTO_CREATE_TABLE)));
    ...
    private String parseTableName() {
        String tableName = fetchProperty(Solon.context(), TYPE_MYSQL, KEY_TABLE_NAME);
