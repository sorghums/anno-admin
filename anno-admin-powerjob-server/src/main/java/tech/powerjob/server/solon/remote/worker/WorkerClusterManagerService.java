...
public class WorkerClusterManagerService {
     ...
     */
    private static final Map<String, ClusterStatusHolder> APP_ID_2_CLUSTER_STATUS = Maps.newConcurrentMap();
    ...
    public static void updateStatus(WorkerHeartbeat heartbeat) {
        ...
        ClusterStatusHolder clusterStatusHolder = APP_ID_2_CLUSTER_STATUS.computeIfAbsent(String.valueOf(appId), ignore -> new ClusterStatusHolder(appName));
     ...
     */
    public static void clean(List<String> usingAppIds) {
        Set<String> keys = Sets.newHashSet(usingAppIds);
    ...
    protected static Map<String, ClusterStatusHolder> getAppId2ClusterStatus() {
