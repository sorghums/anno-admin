...
public class ClusterStatusHolder {
     ...
     */
    private Map<String, Map<String, DeployedContainerInfo>> containerId2Infos;
    ...
    public void updateStatus(WorkerHeartbeat heartbeat) {
        ...
        if (!CollectionUtils.isEmpty(containerInfos)) {
            containerInfos.forEach(containerInfo -> {
                Map<String, DeployedContainerInfo> infos = containerId2Infos.computeIfAbsent(String.valueOf(containerInfo.getContainerId()), ignore -> Maps.newConcurrentMap());
     ...
     * @return 该容器的部署情况
     */
    public List<DeployedContainerInfo> getDeployedContainerInfos(String containerId) {
