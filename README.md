...
## 更新记录
### 2026-04-14 1.2.4[settings.xml](../../../AppData/Roaming/JetBrains/IntelliJIdea2025.3/plugins/maven/lib/maven3/conf/settings.xml)
+ 修复部分bug

### 2025-12-31 1.2.4-SNAPSHOT
+ 修复列表内数据操作后表单内树未更新
+ 新增 QueryType.SIMPLE_LIKE 支持默认%xxx%
+ 修复左侧菜单列表排序与菜单管理页内顺序相反
+ 修复@AnnoField注解的sort值未生效
